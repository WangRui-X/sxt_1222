...
public class ProductCateGoryChildrenListDirective extends BaseDirective{
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body)
		...
		List<ProductCateGory> productChildrenCateGories=productCateGoryService.findChildrenList(count.intValue(),productCategoryId);
		
		//输出
		setVariable(env, body, "productChildrenCateGories", productChildrenCateGories);
